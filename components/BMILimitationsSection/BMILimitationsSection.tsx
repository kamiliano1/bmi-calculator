...
const BMILimitationsSection: React.FC<BMILimitationsSectionProps> = () => {
  return (
    <section
      className="px-6 sm:px-10 text-center mb-20 max-w-[1440px] mx-auto sm:flex sm:flex-wrap sm:justify-center xl:justify-start xl:items-center xl:px-[clamp(2.5rem,_10vw,_8.75rem)] xl:gap-y-8"
      role="complementary"
    >
